    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="bg-background border border-border rounded-2xl p-6 w-full max-w-md shadow-2xl">
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-foreground font-mono font-bold">{title}</h3>
        ...
        <div className="space-y-4">
          <div>
            <label className="text-[11px] font-mono text-muted-foreground uppercase tracking-wider block mb-2">{placeholder}</label>
            <input 
              autoFocus
              className="w-full bg-black/50 border border-border rounded-xl py-3 px-4 text-sm font-mono text-foreground focus:border-blue-500 focus:outline-none transition-colors"
              value={name}
