...
export default function SupplierMasterPage() {
  ...
  const handleSaveNote = async () => {
    ...
    const result = await updateSupplier(activeSupplier.id, { timeline: updatedTimeline });
                ...
                <div className="flex flex-col sm:flex-row gap-6 items-start mb-8">
                  ...
                  <div className="flex-1 min-w-0 pr-12">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <select
                        value={activeSupplier.entityStatus}
                        onChange={(e) => updateSupplier(activeSupplier.id, { entityStatus: e.target.value as any })}
                        className={cn(
                          ...
                          activeSupplier.entityStatus === 'INACTIVE' && "bg-muted text-muted-foreground border-border",
              ...
              <div className="glass p-8 rounded-4xl border border-border">
                ...
                {detailTab === 'timeline' && (
                  <div className="space-y-6">
                    ...
                    {/* Timeline List */}
                    <div className="max-h-62 overflow-y-auto custom-scrollbar pr-2 space-y-6 relative before:absolute before:left-2.75 before:top-2 before:bottom-2 before:w-px before:bg-muted">
