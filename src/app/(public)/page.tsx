  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden selection:bg-blue-500/30">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        <div className="absolute top-0 left-1/4 w-200 h-200 bg-blue-600/10 rounded-full blur-[120px] mix-blend-screen transform -translate-y-1/2" />
        <div className="absolute bottom-0 right-1/4 w-150 h-150 bg-violet-600/10 rounded-full blur-[100px] mix-blend-screen transform translate-y-1/2" />
        <div className="absolute inset-0 bg-[url('/grid.svg')] bg-center [mask-image:linear-gradient(180deg,white,rgba(255,255,255,0))]" />
      </div>

      {/* Header */}
      <header className="fixed top-0 w-full z-50 border-b border-border bg-black/50 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-muted-foreground/60">
          ...
          <div className="flex items-center gap-4">
            {status === 'loading' ? (
              ...
              <Link href="/dashboard">
                <button className="px-5 py-2.5 rounded-xl bg-muted border border-border text-sm font-medium hover:bg-accent transition-all flex items-center gap-2">
      ...
      <main className="relative z-10 pt-32 pb-20 px-6">
        <div className="max-w-7xl mx-auto mt-20 text-center">
          <motion.div 
            ...
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-muted border border-border text-xs font-mono text-blue-400 mb-8"
          >
          ...
          <motion.p 
            ...
            className="text-lg md:text-xl text-muted-foreground/50 max-w-2xl mx-auto mb-12"
          >
          ...
          >
            ...
            <button className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-muted border border-border hover:bg-accent text-foreground font-medium transition-all flex items-center justify-center gap-2">
        ...
        <div className="max-w-7xl mx-auto mt-40">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <motion.div 
              ...
              className="glass p-8 rounded-4xl border border-border bg-white/2 hover:bg-white/4 transition-colors group"
            >
      ...
      <footer className="border-t border-border py-12 mt-20">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm font-mono text-muted-foreground/40">© 2026 ExLogis ERP. All rights reserved.</p>
          <div className="flex items-center gap-6 text-sm font-mono text-muted-foreground/40">
