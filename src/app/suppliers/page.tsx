...
export default function SupplierMasterPage() {
  ...
  const dashboardStats = useMemo(() => {
    const active = rawSuppliers.filter(s => s.entityStatus === 'ACTIVE');
  ...
  return (
    <MasterPage 
      title="Vendor Hub" 
      subtitle="Export Supply Chain Cooperatives & Performance Control"
      loading={loading}
    >
                    ...
                    >
                      ...
                      <td className="py-4 px-6 text-right">
                        <span className={cn(
                          ...
                          s.entityStatus === 'ACTIVE' && "bg-emerald-500/10 text-emerald-400 border border-emerald-500/20",
